...
*
*****************************************************************************/
int change_partition_element_PCAP(virtual_architecture_t *virtual_architecture, int x, int y, int num_element);
int change_partition_element_HBICAP(virtual_architecture_t *virtual_architecture, int x, int y, int num_element);
/****************************************************************************/
/**
*
